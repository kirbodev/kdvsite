      ...
      <div className="absolute -left-4 top-3 md:-left-20">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#ff7350" stopOpacity="0"></stop>
              <stop stopColor="#ff7350"></stop>
              <stop offset="0.325" stopColor="#ffc17a"></stop>
              <stop offset="1" stopColor="#ffc17a" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>

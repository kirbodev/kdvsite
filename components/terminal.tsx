...
function TerminalController({ className }: { className?: string }) {
  ...
  const commands: Command[] = [
    ...
    },
    {
      ...
      run: async () => {
        ...
        // holy shit what did i just see, what was i thinking
  ...
  const sounds = useMemo<{
    ...
    () => ({
      ...
      catastrophic: { src: "/audio/catastrophic.mp3" },
      success: { src: "/audio/beep1.wav" },
      info: { src: "/audio/info.wav" },
      warning: { src: "/audio/warning.mp3" },
      bootup: { src: "/audio/bootup.mp3" },
      bg1: {
        src: "/audio/electricbg.wav",
        volume: 0.2,
        loop: true,
      },
    }),
